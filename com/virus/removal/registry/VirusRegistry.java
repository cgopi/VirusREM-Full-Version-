...
public class VirusRegistry {
	...
	private final static String HKCU_WINLOGON_SHELL = "HKCU\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon";
	...
	public List<String> getVirusSearchList() {
		...
		//virusSearchList.add(HKCU_SOFTWARE);
		...
		//virusSearchList.add(HKLM_CLASSES);
